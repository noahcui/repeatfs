...
from repeatfs.plugins.distributed.provenance.io_record import IORecord
from repeatfs.plugins.distributed.provenance.process_record import ProcessRecord
from repeatfs.plugins.distributed.provenance.graph import Graph
from repeatfs.plugins.distributed.provenance.render_graphviz import RenderGraphviz
from repeatfs.plugins.distributed.provenance.render_json import RenderJSON
from repeatfs.plugins.distributed.timing.timing import ServerVectorTime
...
class Management:
    ...
    def __init__(self, core):
        ...
        self.clock = ServerVectorTime(self.core)
    ...
    def register_write(self, descriptor, op_type=OP_IO, pid=None, update_process=True, io_time=None):
        ...
        IORecord.get(descriptor, self, pid=pid).update(IORecord.IO_WRITE, op_type, io_time=io_time,batch = 1)
